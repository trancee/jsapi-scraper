...
var galaxusNames = []string{
	...
	"Moto g54 5G Power Edition 12/256 Midnight Blue",
	"Motorola 30 Neo",
	"Motorola 22",
	"Motorola 41",
	"Motorola Defy",
	...
	"Motorola MOT DS MOTO G31 4+128 TIM GRY",
	...
	"Nokia X20 (6GB)",
	"Nokia XR20",
	"Nothing Phone (2a) mit Nothing Ear (2) in schwarz",
	"OnePlus 3T",
	"OnePlus 5T",
	"OnePlus 6",
	"OnePlus 6T (8GB)",
	...
	"OPPO Find X3 Neo",
	"OPPO Find X5 Lite",
	"OPPO MOBILE A78 8GB 128GB 5G GLOWING BLACK",
	"OPPO OPP DS RENO8 LITE 5G 8+128 OEM EU BLK",
	"OPPO OPPO Reno 8 Lite",
	"OPPO Reno 7 Lite",
	"OPPO Reno 8 Lite",
	"OPPO Reno4 Pro",
	"OPPO Reno4 Z",
	...
	"Phone Recycle Solution iPhone 8",
	"Poco M4 Pro",
	...
	"realme Smartfon Realme C67 6/128 złoty",
	...
	"Vivo NEX S",
	"Vivo Smartphone VIVO Y22s 6/128GB Blau",
	"Vivo VIV DS Y01 3+32 TIM BLK",
	"Vivo X60 Pro 5G",
	...
	"Xiaomi Redmi10 2022",
	"Xiaomi Redmi 10",
	"Xiaomi Redmi 10 5G stříbrná/6,58´´90HZ/FullHD+/2GHz OC/4GB/128GB/SD/2xSIM/50+2+5MPx/5000mAh",
	...
	"Xiaomi Redmit Note 13 Pro 4G",
	"Xiaomi Samsung Galaxy A14 5G",
	"Xiaomi Telefon M5/64GB Gelb MZB0C9FEU",
	"Xiaomi TIM Xiaomi Redmi 10 2022 16.5 cm (6.5\") Dual SIM Android 11 4G USB Type-C 4 GB 128 GB 5000 mAh Pilka",
	...
	"Xiaomi XIOAMI REDMI NOTE 13 6+128GB NFC DS 4G ICE BLUE OEM",
	"ZTE Blade A31",
	"ZTE Blade A31 Lite",
