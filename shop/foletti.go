...
var FolettiCleanFn = func(name string) string {
	...
	name = regexp.MustCompile(` XT\d{4}-\d+|SMARTPHONE\s*|Smartphone\s*|Smartfon\s*|Solutions |TIM | Mobility Motorola| Mobility| Outdoor| NE| EE|o2-Aktion `).ReplaceAllString(name, "")
