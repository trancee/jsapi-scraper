...
var TuttiRegex = regexp.MustCompile(`(?i)[,-]? ?(2|4|6|8|16|32|54|64|65|128|256|265) ?([MG]B|BG|G)( RAM)?|\b6\/128\b|\/6\s+| \d"| [45] ?G| GSM| (ancora|(electric )?black|blau|chrome|Glacier|(Graphite )?gray|onyx|Pearl White|red edition|rose|(rose )?gold|nero|rosa|roségold|rosso|rot|schwarz|silber|silver|space gr[ae]y|(in )?weiss|white)| mit | und | [*|] | \(| \/|, |\/ | - `)
