...
var TuttiRegex = regexp.MustCompile(`(?i)[,-]? ?\b(2|4|6|8|16|32|54|64|65|128|250|256|265|512) ?([MG][BG]|BG|G|\+)( RAM)?|(\. )?\b(6|8|12|128|256)(GB)?\/(6|8|12|128|256)(GB)?\b|\/6\s+| \d"| [45] ?G| GSM| inkl\. | mit | und | and more| [*|] | \([^\d]| \/|, |\/ | -`)
