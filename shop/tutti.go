...
var TuttiRegex = regexp.MustCompile(`(?i)[,-]? ?[\[(]?\b((2|3|4|6|8|12|16)[/]?)?(2|3|4|6|8|12|16|32|54|64|65|128|250|256|265|512)[ ./]?([KMG][BG]|BG|G|B\b|\+)[)\]]?( RAM)?|(\. )?\b(6|8|12|128|256|512)(GB)?/(6|8|12|128|256)(GB)?\b|GB 64|/6\s+|\(\d\.\d{1,2} "| \d(\.\d{1,2})?"|\d+ mm|-?[ (/]?[45] ?G[)]?| gb$| GSM| LTE| inkl\. | mit | und | and more| plié| [*|] | \([^\d]| /|, |/ | -|;`)
