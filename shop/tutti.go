...
var TuttiRegex = regexp.MustCompile(`(?i)[,-]? ?(2|4|6|8|12|16|32|54|64|65|128|256|265|512) ?([MG][BG]|BG|G)( RAM)?|\b(6|8|128|256)\/(6|8|128|256)(GB)?\b|\/6\s+| \d"| [45] ?G| GSM| inkl\. | mit | und | [*|] | \(| \/|, |\/ | -`)
