...
var UltimusExclusionRegex = regexp.MustCompile(`(?i)Adapter|Armband|Ch?inch|Christbaum|Etui|Halterung|Kopfhörer|Ladegerät|Ladestation|Netzkabel|Objektiv|Robustes Smartphone$|Saugnapf|Schutzfolie|Smartphone mit 100MP Kamera|Stativ|Virtual-Reality|Wasserdicht(es)?|Weihnachtsbaum|Windschutzscheibe`)
