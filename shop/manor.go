...
var ManorCleanFn = func(name string) string {
	name = strings.NewReplacer(" NOK ", " ", " Smartphone Pack ", " ", " Smartphone Bundle ", " ", " Pack Smartphone Vivo", " ", " Smartphone", " ", "NOKIA Nokia ", "Nokia ", "OPPO OPPO ", "OPPO ", "OPPO Oppo ", "OPPO ", "SAMSUNG SM SAMSUNG", "SAMSUNG", "Enterprise Edition", "EE").Replace(name)
