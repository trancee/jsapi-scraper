...
func XXX_bohnettrade(isDryRun bool) IShop {
	const _name = "BohnetTrade"
	const _url = "https://www.bohnettrade.ch/de/categories/telco--ucc/mobiltelefonie-3802/smartphones-380203?limit=100&sort=price|asc&c380203=[38020301]"
